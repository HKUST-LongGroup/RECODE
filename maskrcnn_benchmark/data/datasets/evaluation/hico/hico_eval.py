...
class HICOEvaluator():
    def __init__(self, preds, gts, subject_category_id, rare_triplets, non_rare_triplets, correct_mat, args = None, name=None):
        '''
        correct_mat: [117, 80]
        '''
        ...
        for index, img_preds in enumerate(preds):
            ...
            # print(hoi_scores.shape, verb_labels.shape)
            ...
            if len(subject_ids) > 0:
                ...
                # print(hoi_scores.shape, verb_labels.shape, object_labels.shape)
                masks = correct_mat[verb_labels, object_labels]  # [11700, ]
                # print(correct_mat.shape)
                # print(masks.shape, hoi_scores.shape)
                hoi_scores *= masks
    ...
    def evaluate(self):
        ...
        torch.save(self.ap, '{}_ap.pth'.format(self.name))
        return map
