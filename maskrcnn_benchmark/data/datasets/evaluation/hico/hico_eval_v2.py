...
from maskrcnn_benchmark.utils.topk import top_k


class HICOEvaluator():
    def __init__(self, preds, gts, rare_triplets, non_rare_triplets, correct_mat, mode_name=None):
        ...
        with open('/home/chenguikun/projects/Zero_Shot_SGG/exp/hoi_hico/{}.json'.format(mode_name), 'w') as f:
        ...
        if self.use_json:
            ...
            with open('/home/chenguikun/projects/Zero_Shot_SGG/exp/hoi_hico/{}.json'.format(mode_name)) as f: 
...
# class HICOEvaluator():
#     def __init__(self, preds, gts, rare_triplets, non_rare_triplets, correct_mat, mode_name):
#         self.overlap_iou = 0.5
#         self.max_hois = 100

#         self.zero_shot_type = None

#         self.use_nms_filter = None
#         self.overlap_iou = 0.5
#         self.max_hois = 100
#         self.use_nms_filter = False
#         self.thres_nms = 0.7
