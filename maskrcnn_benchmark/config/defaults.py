...
_C.FEAT_DIR = "."
_C.PRO_DIR = "."
_C.FEAT_TYPE = "offline"
# VG
_C.SEMANTIC_GROUP = [11, 12, 13, 14, 15, 18, 19, 21, 24, 25, 26, 28, 34, 35, 37, 38, 39, 40, 41, 42, 44, 45, 46, 47]
# GQA 
_C.GQA_SEMANTIC_GROUP = [8, 15, 18, 19, 21, 22, 23, 24, 25, 26, 27, 28, 30, 33, 34, 35, 36, 37, 38, 39, 40, 42, 43, 44, 46, 47]
_C.TEST_GROUP = None
_C.GPT_DIR = '.'
_C.GPT = False
_C.TOPK = 3
_C.BOTH = False
_C.ANIMAL = ['animal', 'bear', 'bird', 'cat', 'cow', 'dog', 'elephant', 'giraffe', 'horse', 'sheep', 'zebra']
_C.HUMAN = ['boy', 'child', 'girl', 'guy', 'kid', 'lady', 'man', 'men', 'people', 'person', 'player', 'skier', 'woman']
_C.GPT_WEIGHT = False
_C.FILTER_CAT = False
_C.WEIGHT_SUM = 1.0
_C.CP = False
...
_C.WEIGHT_PATH = './exp/vg/des_weight.npy'
_C.SUB_PATH = './exp/vg/sub_valid_tris.npy'
_C.OBJ_PATH = './exp/vg/obj_valid_tris.npy'
_C.GPT_DES_PATH = './exp/vg/des_prompts.pth'
_C.GPT_POS_PATH = './exp/vg/spatial_logits.pth'
_C.SPATIAL_IMG_PATH = './exp/vg/spatial_imgs'
_C.SF_TAU = 1.0
_C.CLIP_MODEL_NAME = 'ViT-B/32'
_C.PHOTO = False
