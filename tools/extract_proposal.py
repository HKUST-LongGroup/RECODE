...
def generate_aug_results(cfg, local_rank, distributed, logger, feat_path):
    ...
    if not os.path.exists(feat_path + '/' + '{}_box_proposal_dict.pth'.format(clip_model_name)):
        results_dict = {}
        ...
        torch.save(results_dict, feat_path + '/' + '{}_box_proposal_dict.pth'.format(clip_model_name))
...
def main():
    ...
    generate_aug_results(cfg, args.local_rank, args.distributed, logger, cfg.FEAT_DIR)
